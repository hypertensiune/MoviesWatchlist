let contentScript = new ContentScript(
    ...
    ["div.PZPZlf.ssJ7i.B5dxMb[data-attrid=title]"],
    ["span.LrzXr.kno-fv.wHYlTd.z8gr9e"],
    ["div[jsname=xQjRM]"],
    "quickActionsGoogle.html"
);

// MutationObserver -- used for running the script each time the page updates (reload/ajax call)
const observer = new MutationObserver(function(mutation){
    // If the #gsr element changes style to overflow: hidden set the contentScript's state as off
